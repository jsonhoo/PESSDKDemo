...
//    private static String myTopic = "/device/" + clientId;//要订阅的主题
    ...
    public void onCreate() {
        ...
        if(mCache == null) {
            ...
            serverConfig = (ServerConfig) mCache.getAsObject("ServerConfig");
        }
        init();
    }

    public void publish(String msg) {
        String topic = "/device/up/" + serverConfig.getClientId();
        Integer qos = 0;
    ...
    private void init() {
        ...
        // 服务器地址（协议+地址+端口号）
        String uri = serverConfig.getServerAddress()+":"+serverConfig.getServerPort();

        if (client == null) {
            client = new MqttAndroidClient(this, uri, serverConfig.getClientId());
            // 设置MQTT监听并且接受消息
            ...
            // 用户名
            conOpt.setUserName(serverConfig.getClientName());
            // 密码
            conOpt.setPassword(serverConfig.getClientKey().toCharArray());     //将字符串转换为字符串数组
    ...
    private IMqttActionListener iMqttActionListener = new IMqttActionListener() {
        ...
        public void onSuccess(IMqttToken arg0) {
            ...
            if (client != null && client.isConnected()) {
                ...
                try {
                    // 订阅myTopic话题
                    String myTopic = "/device/down/" + serverConfig.getClientId();
    ...
    private MqttCallback mqttCallback = new MqttCallback() {
        ...
        public void messageArrived(String topic, MqttMessage message) throws Exception {
            ...
            if (IGetMessageCallBack != null) {
                IGetMessageCallBack.onMessageArrived(str1);
            }
